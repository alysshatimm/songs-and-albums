...
public class Populator implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Song jukeboxHero = new Song(four, "JukeBox Hero", "3:47", "https://www.youtube.com/embed/W_TOsFvnmeQ");
        songRepo.save(jukeboxHero);
        Song urgent = new Song(four, "Urgent", "2:52", "https://www.youtube.com/embed/Lcb-Fsx_phM");
        songRepo.save(urgent);
        Song myGirls = new Song(merriweatherPostPavillion, "My Girls", "4:30", "https://www.youtube.com/embed/zol2MJf6XNE");
        songRepo.save(myGirls);
        Song blueish = new Song(merriweatherPostPavillion, "Bluish", "6:00", "https://www.youtube.com/embed/YTCg1Ovu64E");
        songRepo.save(blueish);
        Song deadLeaves = new Song(whiteBloodCells, "Dead Leaves and the Dirty Ground", "3:20", "https://www.youtube.com/embed/7OyytKqYjkE");
        songRepo.save(deadLeaves);
        Song hotelYorba = new Song(whiteBloodCells, "Hotel Yorba", "2:50", "https://www.youtube.com/embed/DZPEUyiNcjA");
        songRepo.save(hotelYorba);
        Song pFunk = new Song(mothershipConnection, "P-Funk Wants To Get Funked Up", "7:41", "https://www.youtube.com/embed/QZtgdoZD2t4");
        songRepo.save(pFunk);
        Song unfunkyUfo = new Song(mothershipConnection, "Unfunky UFO", "4:24", "https://www.youtube.com/embed/JtobYqDQV54");
        songRepo.save(unfunkyUfo);
        Song makingPlans = new Song(drumsAndWires, "Making Plans For Nigel", "5:20", "https://www.youtube.com/embed/mfsYSPCNWCw");
        songRepo.save(makingPlans);
        Song outsideWorld = new Song(drumsAndWires, "Outside World", "3:18", "https://www.youtube.com/embed/UacEJL9QZEM");
        songRepo.save(outsideWorld);
        Song redbone = new Song(awakenMyLove, "Redbone", "5:17", "https://www.youtube.com/embed/Kp7eSUU9oy8");
        songRepo.save(redbone);
        Song california = new Song(awakenMyLove, "California", "4:20", "https://www.youtube.com/embed/zGTnrUJZVbU");
        songRepo.save(california);
        Song bornUnderPunches = new Song(remainInLight, "Born Under Punches", "3:16", "https://www.youtube.com/embed/w6T_X7MXg40");
        songRepo.save(bornUnderPunches);
        Song crosseyedAndPainless = new Song(remainInLight, "Crosseyed and Painless", "2:22", "https://www.youtube.com/embed/_Zrkf65GmwE");
        songRepo.save(crosseyedAndPainless);
        Song toTheBlade = new Song(getToHeaven, "To The Blade", "5:55", "https://www.youtube.com/embed/7EeSjfPQYMs");
        songRepo.save(toTheBlade);
        Song gettoHeaven = new Song(getToHeaven, "Get To Heaven","7:00", "https://www.youtube.com/embed/6D3gntAlrfU");
        songRepo.save(gettoHeaven);
        Song seeNoEvil = new Song(marqueeMoon, "See No Evil", "3:47", "https://www.youtube.com/embed/a7L0IYPXKj8");
        songRepo.save(seeNoEvil);
        Song venus = new Song(marqueeMoon, "Venus", "4:45", "https://www.youtube.com/embed/4f3d5ZdE4vY");
        songRepo.save(venus);
        Song theWidow = new Song(francesTheMute, "The Widow", "9:56", "https://www.youtube.com/embed/VUBQLnEGHNk");
        songRepo.save(theWidow);
        Song lViaLViaquez = new Song(francesTheMute, "L'Via L'Viaquez", "8:56", "https://www.youtube.com/embed/JphZtpafdKY");
        songRepo.save(lViaLViaquez);
        Song bringDaRuckus = new Song(thirtySixChambers, "Bring Da Ruckus", "4:20", "https://www.youtube.com/embed/bn3E5QAEt18");
        songRepo.save(bringDaRuckus);
        Song cream = new Song(thirtySixChambers, "C.R.E.A.M.", "4:20", "https://www.youtube.com/embed/PBwAxmrE194");
        songRepo.save(cream);
